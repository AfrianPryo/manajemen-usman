    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-md border border-neutral-100 dark:border-slate-700 p-6 shadow-sm shadow-black/[0.02] flex flex-col justify-between">
            ...
            <div class="pt-5 border-t border-neutral-100 dark:border-slate-700 mt-6">
                <button wire:click="export" class="w-full text-xs font-bold text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-white bg-neutral-50 dark:bg-slate-900 hover:bg-neutral-100 dark:hover:bg-slate-700 py-3 rounded-2xl border border-neutral-200/80 dark:border-slate-700 transition-all flex items-center justify-center gap-2 shadow-2xs group">
