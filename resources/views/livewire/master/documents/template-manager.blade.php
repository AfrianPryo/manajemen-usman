                        ...
                        <tr wire:key="tpl-{{ $tpl->id }}" class="hover:bg-neutral-50/60 dark:hover:bg-slate-700/30 transition-colors">
                            ...
                            <td class="px-4 py-3.5">
                                <div class="flex items-center justify-center gap-1">
                                    ...
                                    <button wire:click="delete({{ $tpl->id }})" wire:confirm="Yakin hapus template ini?" class="p-1.5 text-rose-600 hover:text-rose-800 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 rounded-md transition-all" title="Hapus">
